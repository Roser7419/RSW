...
execute if score $mini_type mem matches 6 run function mini:boomer/game_init
...
execute if score $mini_type mem matches 103 run function mini:collect/game_init