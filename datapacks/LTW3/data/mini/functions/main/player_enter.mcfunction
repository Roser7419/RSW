...
execute if score $mini_type mem matches 6 run function mini:boomer/player_enter
...
execute if score $mini_type mem matches 103 run function mini:collect/player_enter