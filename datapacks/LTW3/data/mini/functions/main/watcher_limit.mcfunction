...
execute if score $mini_type mem matches 6 run function mini:boomer/watcher_limit
...
execute if score $mini_type mem matches 103 run function mini:collect/watcher_limit