...
tellraw @s ["",{"text": ">> ","color":"light_purple","bold": true},"你的RSW等级提升至了 ",{"text":"3","color":"light_purple"}, " 级, 因此你还额外得到了 " ,{"text":"3 紫水晶","color":"light_purple"}," 作为奖励！"]
function lib:sounds/levelup
execute unless score @s rsw_rank >= #3 mem run scoreboard players set @s rsw_rank 3