# 给予紫水晶
summon item ~ ~ ~ {Item:{id:"amethyst_shard",Count:1b,tag:{stats_item:1b}},Tags:["score_item","new_stats"],PickupDelay:0}
...
execute if score @s temp matches 1.. run function item:shop/summon_amethyst
