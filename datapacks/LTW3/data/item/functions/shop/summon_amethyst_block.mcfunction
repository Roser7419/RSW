# 哦是的我当然知道不能这么合成, 但是你想拿着一组多紫水晶吗

# 给予紫水晶块
summon item ~ ~ ~ {Item:{id:"amethyst_block",Count:1b,tag:{stats_item:1b}},Tags:["score_item","new_stats"],PickupDelay:0}
...
execute if score @s temp matches 1.. run function item:shop/summon_amethyst_block
